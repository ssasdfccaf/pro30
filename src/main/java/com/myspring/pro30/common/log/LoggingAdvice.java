...
public class LoggingAdvice {
	...
	// target �޼����� �Ķ���͵� ������ ����մϴ�.
	/*@Before("execution(* com.myspring.pro30.member.service.*.*(..)) or "
			+ "execution(* com.myspring.pro30.member.dao.*.*(..))")*/
	...
	/*@After("execution(* com.myspring.pro30.member.service.*.*(..)) or "
			+ "execution(* com.myspring.pro30.member.dao.*.*(..))")*/ 
	...
	/*@Around("execution(* com.myspring.pro30.member.service.*.*(..)) or "
			+ "execution(* com.myspring.pro30.member.dao.*.*(..))")*/
